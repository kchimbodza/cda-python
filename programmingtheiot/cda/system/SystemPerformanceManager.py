...
class SystemPerformanceManager(object):
    ...
    def __init__(self, pollRate: float = ConfigConst.DEFAULT_POLL_CYCLES):
        configUtil = ConfigUtil()
        
        self.pollRate = pollRate if pollRate > 0 else \
        ...
        # Create system utility tasks
        self.cpuUtilTask = SystemCpuUtilTask()
        self.memUtilTask = SystemMemUtilTask()
        
        # Initialize utilization percentages
        self.cpuUtilPct = 0.0
        self.memUtilPct = 0.0
