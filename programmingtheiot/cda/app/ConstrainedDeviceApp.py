...
def main():
    ...
    Current implementation runs for 65 seconds then exits, unless configured to run forever.
    """
    argParser = argparse.ArgumentParser(
        description='CDA used for generating telemetry - Programming the IoT.')
    
    argParser.add_argument('-c', '--configFile', 
                          help='Optional custom configuration file for the CDA.')
